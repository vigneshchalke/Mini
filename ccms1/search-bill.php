                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="search.php">Search Bills</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Search Bills</strong>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                       ...
                                       <div class="form-group row">
                                                        <label class="col-4 col-form-label" for="example-email" style="padding-left: 50px"><strong>Search by Bill_ID</strong></label>
                                                        <div class="col-6">
...
while ($row=mysqli_fetch_array($ret)) {
    ?>
                ...
                <tr>
                  ...
                  <td><a href="view-bill-detail.php?upid=<?php echo $row['ID'];?>" class="btn btn-primary btn-sm">View</a></td>
                </tr>
                 <?php 
$cnt=$cnt+1;
} } else { ?>
